  ...
  public parseMTL(
    ...
    for (let i = 0; i < lines.length; i++) {
      ...
      if (key === "newmtl") {
        ...
        material.ambientTexture = MTLFileLoader._GetTexture(
          rootUrl,
          value,
          scene
        );
        ...
        material.diffuseTexture = MTLFileLoader._GetTexture(
          rootUrl,
          value,
          scene
        );
        ...
        //We must first get the folder of the image
        material.specularTexture = MTLFileLoader._GetTexture(
          rootUrl,
          value,
          scene
        );
        ...
        material.bumpTexture = MTLFileLoader._GetTexture(
          rootUrl,
          values.join(" "),
          scene
        );
        ...
        material.opacityTexture = MTLFileLoader._GetTexture(
          rootUrl,
          value,
          scene
        );
